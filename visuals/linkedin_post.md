...
The design idea I kept coming back to: **a dashboard tells you there's a problem; a command center tells you what to do first.** Every metric in this system ends in a queue, a priority, and an owner.
